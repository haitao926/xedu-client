...
const ACTIONS = Object.freeze({
    ...
    'resources.submitStudentScreenshot': (app) => app.resources?.submitStudentScreenshot?.(),
    ...
    'ai.toggleStudentAssistant': (app) => app.ai?.toggleStudentAssistant?.(),
    'ai.closeStudentAssistant': (app) => app.ai?.closeStudentAssistant?.(),
    ...
    'system.scanPythonEnvironments': (app) => app.system?.scanPythonEnvironments?.(),
    'system.confirmPythonEnvironment': (app) => app.system?.confirmPythonEnvironment?.(),
