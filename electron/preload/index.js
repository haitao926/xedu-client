...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    onDeepLinkOpenLocalTask: (callback) => ipcRenderer.on('deep-link-open-local-task', (_event, payload) => callback(payload)),
    xeduGetLocalTask: () => ipcRenderer.invoke('xedu:local-task-state'),
