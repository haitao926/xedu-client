# XEdu Client 2.0.0 RC.5 Known Issues
...
|---|---|---|
| P0 | RC5 source is frozen, but formal artifact trust and teacher acceptance are not closed | Keep all platform builds on `v2.0.0-rc.5`; any later code change requires a new RC tag, and formal distribution remains blocked until the remaining P0/P1 gates close. |
