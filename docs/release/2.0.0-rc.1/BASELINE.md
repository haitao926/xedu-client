...
| Release candidate source commit | `89cdbd95`; implementation commit `Freeze a reproducible teacher release candidate`; identity documentation commit is the tagged RC source |
| Exact release tag | `v2.0.0-rc.1` (created immediately after the identity documentation commit) |
...
- The RC source commit and `v2.0.0-rc.1` tag are frozen for validation; this does not authorize formal teacher distribution.
