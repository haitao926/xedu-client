...
xedu_video_stream = xrt.XEduCamera.video('demo.mp4', window_name="COCO 目标检测 视频流")
try:
  print("视频流已启动: COCO 目标检测 视频流")
...
xrt.xedu_show_result_card(lab_result, title="COCO 目标检测 视频 视频")
