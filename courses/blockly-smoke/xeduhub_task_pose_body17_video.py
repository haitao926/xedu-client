...
xedu_video_stream = xrt.XEduCamera.video('demo.mp4', window_name="人体关键点 17 视频流")
try:
  print("视频流已启动: 人体关键点 17 视频流")
...
xrt.xedu_show_result_card(lab_result, title="人体关键点 17 视频 视频")
