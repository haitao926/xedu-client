...
COMMANDS = (
    ...
    (
        "electron lifecycle and backend network tests",
        [
            "node",
            "--test",
            "electron/test/backend-network-config.test.mjs",
            "electron/test/shutdown-lifecycle.test.mjs",
        ],
    ),
    ...
    (
        "resources state and index flow tests",
        [
            "node",
            "--test",
            "renderer/js/resources/resources-state.test.js",
            "renderer/js/resources/resource-index-flow.test.js",
        ],
    ),
