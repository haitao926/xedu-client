...
from .sample_assets import (
    XEDUHUB_SMOKE_VIDEO,
    XEDUHUB_SMOKE_VIDEO_ALIASES,
    XEDUHUB_SMOKE_VIDEO_POSTER,
    repo_path,
)

REPO_ROOT = Path(__file__).resolve().parents[2]
DEFAULT_SAMPLE_VIDEO = XEDUHUB_SMOKE_VIDEO
DEFAULT_SAMPLE_VIDEO_IMAGE = XEDUHUB_SMOKE_VIDEO_POSTER
DEFAULT_SAMPLE_VIDEO_ALIASES = set(XEDUHUB_SMOKE_VIDEO_ALIASES)
